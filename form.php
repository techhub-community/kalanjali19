...
<html lang="en">
    <head>
      ...
      <script async src="https://www.googletagmanager.com/gtag/js?id=UA-149436891-1"></script>
      <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-149436891-1');
      </script>
...
.signin {
        ...
        <div class=main_menu>
            <nav class="navbar navbar-expand-lg navbar-light header_area_black_color">
                <div class="container box_1620">
                    <a href="index.html" class="logo_h navbar-brand"><img alt=Logo class=round-img src=img/collegelogo.png height=65 width=65></a>
  ...
  <div class="container">
    ...
    <left><a href="http://bit.ly/2oJUpE6" target=_blank class=tickets_btn>Click here for Brochure of Kalanjali.</a></left>
    <br><br>
    </center>
    <hr>
